/*
 * mods/tele.c - one-shot child-process capture and telephony state probes.
 *
 * Shared by the call plugins (mods/ring.c, mods/dialer.c); nothing in
 * the core calls it directly. Everything is event-triggered, no polling.
 */
